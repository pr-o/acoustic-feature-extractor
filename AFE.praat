...
#
# #################
# ##  AFE.praat  ## - Acoustic Feature Extractor
# #################
#
#                     Sung Hah Hwang (August 5, 2017)
#
#
...
form Acoustic Feature Extractor
  ...
  comment ⦿ Split each segment into how many chunks:
    positive Chunks 3
...
printline Result file path:'tab$''tab$''resultFile$'
printline 'delim$'
